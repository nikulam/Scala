...
object factory {
  ...
  def buildBusWriteUnit4(r0: Bus, r1: Bus, r2: Bus, r3: Bus,
    ...
    val g0 = writeEnable&&((!writeTo(1))&&(!writeTo(0)))
    val g1 = writeEnable&&((!writeTo(1))&&(writeTo(0)))
    val g2 = writeEnable&&((writeTo(1))&&(!writeTo(0)))
    val g3 = writeEnable&&((writeTo(1))&&(writeTo(0)))
    
    val b0 =  ((data && g0)| (r0 && !g0)) && !reset
    val b1 =  ((data && g1)| (r1 && !g1)) && !reset
    val b2 =  ((data && g2)| (r2 && !g2)) && !reset
    val b3 =  ((data && g3)| (r3 && !g3)) && !reset
