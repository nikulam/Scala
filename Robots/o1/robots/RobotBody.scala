...
class RobotBody(val world: RobotWorld, initialLocation: GridPos, initialFacing: CompassDir) { 
  ...
  def neighboringSquare(direction: CompassDir) = this.location // TODO: replace with a working implementation
  ...
  def canMoveTowards(direction: CompassDir) = true // TODO: replace with a working implementation
